About knotifications-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/knotifications-feedstock/blob/main/LICENSE.txt)
...
<table>
  ...
  <tr>
    ...
    <td>
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8513&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/knotifications-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8513&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/knotifications-feedstock?branchName=main&jobName=linux&configuration=linux%20linux_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Once the `conda-forge` channel has been enabled, `knotifications` can be installed with `conda`:
...
```
mamba install knotifications
```

It is possible to list all of the versions of `knotifications` available on your platform with `conda`:
...
```
mamba search knotifications --channel conda-forge
```
...
mamba repoquery search knotifications --channel conda-forge

# List packages depending on `knotifications`:
mamba repoquery whoneeds knotifications --channel conda-forge

# List dependencies of `knotifications`:
mamba repoquery depends knotifications --channel conda-forge
```
